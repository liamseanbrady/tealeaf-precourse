...
# This will print "FALSE", because a string and int are not equal
...
# This will print "Did you get it right?", because (3 == 3) is true
...
# This will print "Alright now!" because x + 1 (11) >= y (9)
